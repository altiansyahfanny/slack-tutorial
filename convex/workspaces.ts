...
const generateCode = () => {
	const code = Array.from({ length: 6 }, () => "01234567890abcdefghijklmnopqrstyvwxyz"[Math.floor(Math.random() * 36)]).join('');
