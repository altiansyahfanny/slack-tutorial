                ...
                await Promise.all(
                    results.page.map(async (message) => {
                        ...
                        const dedupedReactions = reactionsWithCount.reduce((acc, reaction) => {
                            ...
                            if (existingReaction) {
                                const memberIds = Array.from(new Set([...existingReaction.memberIds, reaction.memberId]));
                                existingReaction.memberIds = memberIds;
                            } else {
                        ...
                        const reacttionsWithoutMemberIdProperty = dedupedReactions.map(({memberId, ...rest}) => rest); 
                        ...
                        return {
                            ...
                            member,
                            user,
                            reactions: reacttionsWithoutMemberIdProperty,
